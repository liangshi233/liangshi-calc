...
export const AllCalc = [
  ...
  },
  {
    ...
    params: { "重击使用次数": 1, "重击命中次数": 2, "重击造成伤害次数": 2, Photosynthesis_Energy: 4, "自我治疗次数": 1 },
  ...
  },
  {
    ...
    params: { "空中攻击使用次数": 1, "空中攻击命中次数": 1, "空中攻击造成伤害次数": 1, "处于空中": true, Photosynthesis_Energy: 4, "自我治疗次数": 1 },
    dmg: ({ talent }, dmg) => dmg(talent.a['空中攻击·星星花绽放第一段伤害'], 'a,a3')
  },
  {
    title: `${TalentName.a3Name}星星花绽放二段`,
    params: { "空中攻击使用次数": 2, "空中攻击命中次数": 2, "空中攻击造成伤害次数": 2, "处于空中": true, Photosynthesis_Energy: 3, "自我治疗次数": 2 },
    dmg: ({ talent }, dmg) => dmg(talent.a['空中攻击·星星花绽放第二段伤害'], 'a,a3')
  },
  {
    title: `${TalentName.a3Name}星星花绽放三段`,
    params: { "空中攻击使用次数": 3, "空中攻击命中次数": 5, "空中攻击造成伤害次数": 5, "处于空中": true, Photosynthesis_Energy: 2, "自我治疗次数": 3 },
    dmg: ({ talent }, dmg) => {
  ...
  {
    title: '星星花绽放治疗',
    params: { "常态攻击使用次数": 4, "常态攻击命中次数": 6, "常态攻击造成伤害次数": 6, "自我治疗次数": 4, "处于空中": true, Photosynthesis_Energy: 1 },
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 3, "共鸣解放命中次数": 3, "共鸣能量降低次数": 1, "自我治疗次数": 2, Photosynthesis_Mark: true },
