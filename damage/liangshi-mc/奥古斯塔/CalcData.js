...
export const AllCalc = [
  ...
  },
  {
    ...
    params: { "重击使用次数": 1, "重击命中次数": 3, "重击造成伤害次数": 3 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "空中攻击使用次数": 1, "空中攻击命中次数": 2, "空中攻击伤害次数": 2, "处于空中": true },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣技能使用次数": 2, "重击命中次数": 2, "重击造成伤害次数": 2 },
    dmg: ({ talent, cons }, dmg) => {
  ...
  },
  {
    ...
    params: { "常态攻击使用次数": 2, "常态攻击命中次数": 3, "常态攻击造成伤害次数": 3, "重击命中次数": 1, "重击造成伤害次数": 1 },
  ...
  },
  {
    ...
    params: { "共鸣技能使用次数": 2, "共鸣技能命中次数": 5, "共鸣技能造成伤害次数": 5 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "重击造成伤害次数": 8, "重击命中次数": 8, "共鸣能量降低次数": 1 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "重击使用次数": 1, "重击造成伤害次数": 1, "重击命中次数": 1 },
    dmg: ({ talent, cons }, dmg) => dmg(talent.q['赫日威临·烈阳伤害'] + (cons >= 3 ? 25 : 0), 'a2')
  },
  {
    title: `${TalentName.qName}不朽者之肃伤害`,
    params: { "共鸣解放使用次数": 2, "重击使用次数": 1, "重击造成伤害次数": 17, "重击命中次数": 17 },
    dmg: ({ talent, cons }, dmg) => {
