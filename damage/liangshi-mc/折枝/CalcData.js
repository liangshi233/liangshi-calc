...
export const AllCalc = [
  ...
  },
  {
    ...
    params: { "常态攻击使用次数": 2, "常态攻击命中次数": 7, "常态攻击造成伤害次数": 7 },
    dmg: ({ talent }, dmg) => {
  ...
  {
    title: `${TalentName.a2Name}伤害`,
    params: { "共鸣技能使用次数": 4, "共鸣技能命中次数": 8, "共鸣技能造成伤害次数": 8, "重击使用次数": 2, "重击命中次数": 6, "重击造成伤害次数": 6 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "空中攻击使用次数": 1, "空中攻击命中次数": 6, "空中攻击造成伤害次数": 6, "处于空中": true },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "常态攻击使用次数": 1, "常态攻击命中次数": 5, "常态攻击造成伤害次数": 5 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣技能使用次数": 3, "共鸣技能命中次数": 5, "共鸣技能造成伤害次数": 5 },
    dmg: ({ talent }, dmg) => dmg(talent.t['神来之笔伤害'], 'a')
  },
  {
    title: `极意·强化${TalentName.eName}`,
    params: { "共鸣技能使用次数": 4, "共鸣技能命中次数": 8, "共鸣技能造成伤害次数": 8 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 6, "共鸣解放命中次数": 6, "共鸣能量降低次数": 1, "共鸣技能使用次数": 4, "共鸣技能命中次数": 8, "共鸣技能造成伤害次数": 8 },
