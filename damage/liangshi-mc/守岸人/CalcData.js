...
export const AllCalc = [
  ...
  },
  {
    ...
    params: { "共鸣技能使用次数": 1, "共鸣技能命中次数": 5, "共鸣技能造成伤害次数": 5, "自我治疗次数": 1, Chaos_Theory: true },
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "常态攻击使用次数": 1, "常态攻击命中次数": 1, "常态攻击造成伤害次数": 1, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => dmg(talent.a['第一段伤害'], 'a')
  },
  {
    title: `${TalentName.qNameT}后${TalentName.aName}二段伤害`,
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "常态攻击使用次数": 2, "常态攻击命中次数": 3, "常态攻击造成伤害次数": 3, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => {
      let a1 = dmg(talent.a['第二段伤害2'][0], 'a')
      return {
        dmg: a1.dmg * 2,
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "常态攻击使用次数": 3, "常态攻击命中次数": 6, "常态攻击造成伤害次数": 6, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => {
      let a1 = dmg(talent.a['第三段伤害2'][0], 'a')
      return {
        dmg: a1.dmg * 3,
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "常态攻击使用次数": 4, "常态攻击命中次数": 7, "常态攻击造成伤害次数": 7, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => dmg(talent.a['第四段伤害'], 'a')
  },
  {
    title: `${TalentName.qNameT}后${TalentName.a2Name}演绎伤害`,
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "重击使用次数": 1, "重击命中次数": 5, "重击造成伤害次数": 5, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => {
      let a1 = dmg(talent.t['演绎伤害2'][0], 'a2')
      return {
        dmg: a1.dmg * 5,
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "常态攻击使用次数": 5, "常态攻击命中次数": 9, "常态攻击造成伤害次数": 9, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => dmg(talent.t['耀星·蝶伤害'], 'a')
  },
  {
    title: `${TalentName.qNameT}后${TalentName.eName}黯星蝶`,
    dmgKey: 'e',
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "共鸣技能使用次数": 1, "共鸣技能命中次数": 5, "共鸣技能造成伤害次数": 5, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
    dmg: ({ talent }, dmg) => dmg(talent.e['黯星·蝶伤害'], 'e')
  },
  {
    title: `${TalentName.qNameT}后${TalentName.a3Name}衍变伤害`,
    params: { "共鸣解放使用次数": 1, "共鸣能量降低次数": 1, "空中攻击使用次数": 1, "空中攻击命中次数": 1, "空中攻击造成伤害次数": 1, "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
  ...
  },
  {
    title: `变奏洞悉伤害`,
    dmgKey: 'i',
    params: { "自我治疗次数": 1, Stellarealm: true, Supernal_Stellarealm: true },
