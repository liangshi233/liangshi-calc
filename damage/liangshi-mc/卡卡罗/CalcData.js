...
export const AllCalc = [
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 1, "共鸣解放命中次数": 1, "共鸣能量降低次数": 1, "杀戮武装": true },
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 1, "共鸣解放命中次数": 1, "共鸣能量降低次数": 1, "杀戮武装": true, "常态攻击使用次数": 2, "常态攻击命中次数": 5, "常态攻击造成伤害次数": 5 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 1, "共鸣解放命中次数": 1, "共鸣能量降低次数": 1, "杀戮武装": true, "常态攻击使用次数": 3, "常态攻击命中次数": 6, "常态攻击造成伤害次数": 6 },
    dmg: ({ talent }, dmg) => dmg(talent.q['猎犬剑技·狂噬影狱第三段'], 'a')
  },
  {
    title: `${TalentName.qNameT}后${TalentName.aName}四段`,
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 1, "共鸣解放命中次数": 1, "共鸣能量降低次数": 1, "杀戮武装": true, "常态攻击使用次数": 4, "常态攻击命中次数": 12, "常态攻击造成伤害次数": 12 },
    dmg: ({ talent }, dmg) => {
  ...
  },
  {
    ...
    params: { "共鸣解放使用次数": 1, "共鸣解放造成伤害次数": 1, "共鸣解放命中次数": 1, "共鸣能量降低次数": 1, "杀戮武装": true, "常态攻击使用次数": 5, "常态攻击命中次数": 14, "常态攻击造成伤害次数": 14 },
    dmg: ({ talent }, dmg) => {
