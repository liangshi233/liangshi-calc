...
},
{
  ...
  cons: 6,
  data: {
    qPlus: ({ calc , attr , params  , cons , weapon }) => ( calc(attr.atk) * ( ( Math.min( ( params.blPct * ( ( 65 + ( cons >= 2 ? 65 : 0 ) ) + ( weapon.name === '赤月之形' ? 25 : 0 ) ) + params.blPlus ) , 200 ) / 200 ) * ( 700 / 100 ) ) ),
    aCpct: 10 ,
    aCdmg: 70 ,
    qCpct: 10 ,
    qCdmg: 70
...
},
{
 ...
 'vaporize',
{title: `4.24最后修改：[4.24重置] 显示模式:${NamePath} 排行设置:${rankingOnePath},${rankingTwoPath},${rankingThreePath} 专属排行设置:${gs96ranking} 魔物产球设置:${energy} 更新日志:${renew} 其他信息:${information}`}]
