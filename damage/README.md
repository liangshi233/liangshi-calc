...
|功能|角色在队伍中起到特殊功能或改变输出环境的作用|
|生存|角色在队伍中为其他角色承担伤害或为其他角色提供治疗或护盾|
|挂件|角色在队伍中没有主要作用，主要以凑天赋或凑元素共鸣为目的|
...
|燃绽|角色为火元素角色，在输出过程中依靠原激化反应带来的提升与烈绽放反应提高自身伤害|
|烈绽|角色为火元素角色，在输出过程中依靠烈绽放反应做为主要输出手段|
|燃烧|角色为火元素或草元素角色角色，在输出过程中依靠燃烧反应获得增益效果或以做燃烧反应为主要输出手段|
|冻结|角色为水元素或冰元素角色，在输出过程中依靠碎冰、冻结反应提高自身或依赖冻结反应提供输出环境伤害|
|结晶|角色为岩元素角色，在输出过程中依靠产生结晶反应的护盾提高自身伤害或为队友与自身提供增益|
|扩散|在输出过程中通过扩散反应或扩散反应造成的伤害为主要输出手段|
|增伤|可以转化一定属性为全队提供伤害类增益效果|
|增益|可以转化一定属性为全队提供非伤害类增益效果|
|充能|可以转化一定属性为全队提供元素能量|
|特化|能够异化元素反应为队伍提供增益效果|
|消解|为队中角色提供转化并消解受到的伤害|
|治疗|为队中其他角色提供治疗效果以保证其生存|
|护盾|为队中其他角色提供护盾效果以保证其生存|
