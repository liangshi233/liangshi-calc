...
import { TeamBuff_Lauma } from "./菈乌玛/TeamBuff.js"
...
// 为每个角色添加属性访问
TeamBuff.TeamBuff_Kamisato_Ayaka = TeamBuff_Kamisato_Ayaka;
TeamBuff.TeamBuff_Jean = TeamBuff_Jean;
TeamBuff.TeamBuff_Lisa = TeamBuff_Lisa;
TeamBuff.TeamBuff_Barbara = TeamBuff_Barbara;
TeamBuff.TeamBuff_Kaeya = TeamBuff_Kaeya;
TeamBuff.TeamBuff_Diluc = TeamBuff_Diluc;
TeamBuff.TeamBuff_Razor = TeamBuff_Razor;
TeamBuff.TeamBuff_Amber = TeamBuff_Amber;
TeamBuff.TeamBuff_Venti = TeamBuff_Venti;
TeamBuff.TeamBuff_Xiang_Ling = TeamBuff_Xiang_Ling;
TeamBuff.TeamBuff_Bei_Dou = TeamBuff_Bei_Dou;
TeamBuff.TeamBuff_Xing_Qiu = TeamBuff_Xing_Qiu;
TeamBuff.TeamBuff_Xiao = TeamBuff_Xiao;
TeamBuff.TeamBuff_Ning_Guang = TeamBuff_Ning_Guang;
TeamBuff.TeamBuff_Klee = TeamBuff_Klee;
TeamBuff.TeamBuff_Zhong_Li = TeamBuff_Zhong_Li;
TeamBuff.TeamBuff_Fischl = TeamBuff_Fischl;
TeamBuff.TeamBuff_Bennett = TeamBuff_Bennett;
TeamBuff.TeamBuff_Tartaglia = TeamBuff_Tartaglia;
TeamBuff.TeamBuff_Noelle = TeamBuff_Noelle;
TeamBuff.TeamBuff_Qi_Qi = TeamBuff_Qi_Qi;
TeamBuff.TeamBuff_Chong_Yun = TeamBuff_Chong_Yun;
TeamBuff.TeamBuff_Gan_Yu = TeamBuff_Gan_Yu;
TeamBuff.TeamBuff_Albedo = TeamBuff_Albedo;
TeamBuff.TeamBuff_Diona = TeamBuff_Diona;
TeamBuff.TeamBuff_Mona = TeamBuff_Mona;
TeamBuff.TeamBuff_Ke_Qing = TeamBuff_Ke_Qing;
TeamBuff.TeamBuff_Sucrose = TeamBuff_Sucrose;
TeamBuff.TeamBuff_Xin_Yan = TeamBuff_Xin_Yan;
TeamBuff.TeamBuff_Rosaria = TeamBuff_Rosaria;
TeamBuff.TeamBuff_Hu_Tao = TeamBuff_Hu_Tao;
TeamBuff.TeamBuff_Kaedehara_Kazuha = TeamBuff_Kaedehara_Kazuha;
TeamBuff.TeamBuff_Yanfei = TeamBuff_Yanfei;
TeamBuff.TeamBuff_Yoimiya = TeamBuff_Yoimiya;
TeamBuff.TeamBuff_Thoma = TeamBuff_Thoma;
TeamBuff.TeamBuff_Eula = TeamBuff_Eula;
TeamBuff.TeamBuff_Raiden_Shogun = TeamBuff_Raiden_Shogun;
TeamBuff.TeamBuff_Sayu = TeamBuff_Sayu;
TeamBuff.TeamBuff_Sangonomiya_Kokomi = TeamBuff_Sangonomiya_Kokomi;
TeamBuff.TeamBuff_Gorou = TeamBuff_Gorou;
TeamBuff.TeamBuff_Kujou_Sara = TeamBuff_Kujou_Sara;
TeamBuff.TeamBuff_Arataki_Itto = TeamBuff_Arataki_Itto;
TeamBuff.TeamBuff_Yae_Miko = TeamBuff_Yae_Miko;
TeamBuff.TeamBuff_Shikanoin_Heizou = TeamBuff_Shikanoin_Heizou;
TeamBuff.TeamBuff_Ye_Lan = TeamBuff_Ye_Lan;
TeamBuff.TeamBuff_Kirara = TeamBuff_Kirara;
TeamBuff.TeamBuff_Aloy = TeamBuff_Aloy;
TeamBuff.TeamBuff_Shen_He = TeamBuff_Shen_He;
TeamBuff.TeamBuff_Yun_Jin = TeamBuff_Yun_Jin;
TeamBuff.TeamBuff_Kuki_Shinobu = TeamBuff_Kuki_Shinobu;
TeamBuff.TeamBuff_Kamisato_Ayato = TeamBuff_Kamisato_Ayato;
TeamBuff.TeamBuff_Collei = TeamBuff_Collei;
TeamBuff.TeamBuff_Dori = TeamBuff_Dori;
TeamBuff.TeamBuff_Tighnari = TeamBuff_Tighnari;
TeamBuff.TeamBuff_Nilou = TeamBuff_Nilou;
TeamBuff.TeamBuff_Cyno = TeamBuff_Cyno;
TeamBuff.TeamBuff_Candace = TeamBuff_Candace;
TeamBuff.TeamBuff_Nahida = TeamBuff_Nahida;
TeamBuff.TeamBuff_Layla = TeamBuff_Layla;
TeamBuff.TeamBuff_Wanderer = TeamBuff_Wanderer;
TeamBuff.TeamBuff_Faruzan = TeamBuff_Faruzan;
TeamBuff.TeamBuff_Yao_Yao = TeamBuff_Yao_Yao;
TeamBuff.TeamBuff_Alhaitham = TeamBuff_Alhaitham;
TeamBuff.TeamBuff_Dehya = TeamBuff_Dehya;
TeamBuff.TeamBuff_Mika = TeamBuff_Mika;
TeamBuff.TeamBuff_Kaveh = TeamBuff_Kaveh;
TeamBuff.TeamBuff_Bai_Zhu = TeamBuff_Bai_Zhu;
TeamBuff.TeamBuff_Lynette = TeamBuff_Lynette;
TeamBuff.TeamBuff_Lyney = TeamBuff_Lyney;
TeamBuff.TeamBuff_Freminet = TeamBuff_Freminet;
TeamBuff.TeamBuff_Wriothesley = TeamBuff_Wriothesley;
TeamBuff.TeamBuff_Neuvillette = TeamBuff_Neuvillette;
TeamBuff.TeamBuff_Charlotte = TeamBuff_Charlotte;
TeamBuff.TeamBuff_Furina = TeamBuff_Furina;
TeamBuff.TeamBuff_Chevreuse = TeamBuff_Chevreuse;
TeamBuff.TeamBuff_Navia = TeamBuff_Navia;
TeamBuff.TeamBuff_Gaming = TeamBuff_Gaming;
TeamBuff.TeamBuff_Xian_Yun = TeamBuff_Xian_Yun;
TeamBuff.TeamBuff_Chiori = TeamBuff_Chiori;
TeamBuff.TeamBuff_Sigewinne = TeamBuff_Sigewinne;
TeamBuff.TeamBuff_Arlecchino = TeamBuff_Arlecchino;
TeamBuff.TeamBuff_Sethos = TeamBuff_Sethos;
TeamBuff.TeamBuff_Clorinde = TeamBuff_Clorinde;
TeamBuff.TeamBuff_Emilie = TeamBuff_Emilie;
TeamBuff.TeamBuff_Kachina = TeamBuff_Kachina;
TeamBuff.TeamBuff_Mualani = TeamBuff_Mualani;
TeamBuff.TeamBuff_Kinich = TeamBuff_Kinich;
TeamBuff.TeamBuff_Xilonen = TeamBuff_Xilonen;
TeamBuff.TeamBuff_Ororon = TeamBuff_Ororon;
TeamBuff.TeamBuff_Chasca = TeamBuff_Chasca;
TeamBuff.TeamBuff_Citlali = TeamBuff_Citlali;
TeamBuff.TeamBuff_Mavuika = TeamBuff_Mavuika;
TeamBuff.TeamBuff_Lan_Yan = TeamBuff_Lan_Yan;
TeamBuff.TeamBuff_Mizuki = TeamBuff_Mizuki;
TeamBuff.TeamBuff_Iansan = TeamBuff_Iansan;
TeamBuff.TeamBuff_Varesa = TeamBuff_Varesa;
TeamBuff.TeamBuff_Escoffier = TeamBuff_Escoffier;
TeamBuff.TeamBuff_Ifa = TeamBuff_Ifa;
TeamBuff.TeamBuff_Dahlia = TeamBuff_Dahlia;
TeamBuff.TeamBuff_Skirk = TeamBuff_Skirk;
TeamBuff.TeamBuff_Ineffa = TeamBuff_Ineffa;
TeamBuff.TeamBuff_Lauma = TeamBuff_Lauma;
