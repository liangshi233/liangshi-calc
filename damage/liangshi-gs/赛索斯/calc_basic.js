...
export const defParams = { ElementSame: 1, ElementMineTeam: 1 }
export const buffs = CalcBuff
export const details = [
{
  title: `二段蓄力${TalentName.a2Name}`,
  params: { Shadowpiercing_Shot: true, EnergyDetermine: 40 },
...
},
{
  ...
  params: { EnergyDetermine: 1, BurstAfter: 2 },
...
},
{
  ...
  params: { EnergyDetermine: 5, BurstAfter: 3 },
