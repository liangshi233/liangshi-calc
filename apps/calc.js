...
export class calc extends plugin {
    ...
    super(
       {
         ...
         rule: [
          {
            reg: '^#*(强制)?更新(.*)(崩坏三|崩坏3|崩三|崩3|bh3|BH3|原神|ys|YS|gs|GS|星铁|sr|SR|崩坏星穹铁道|崩坏：星穹铁道|铁道|绝区零|zzz|ZZZ|绝|鸣潮|mc|MC|明朝|潮|幻塔|HT|ht|幻塔PSN|幻塔psn|HTPSN|htpsn|战双|ZS|zs|战双帕弥什|帕弥什|PNS|pns|尘白|CBJQ|cbjq|尘白禁区)(计算|伤害计算)$',
            fnc: 'calc'
          }
        ]
      }
  ...
  async calc (e) {
    ...
    if (/原神|ys|YS|gs|GS/.test(this.e.msg)) {
      calcdata = 'gs'
    } else if (/星铁|sr|SR|崩坏星穹铁道|崩坏：星穹铁道|铁道/.test(this.e.msg)) {
      calcdata = 'sr'
    } else if (/鸣潮|mc|MC|明朝|潮/.test(this.e.msg)) {
      calcdata = 'mc'
    } else if (/绝区零|zzz|ZZZ|绝/.test(this.e.msg)) {
      calcdata = 'zzz'
    } else if (/崩坏三|崩坏3|崩三|崩3|bh3|BH3/.test(this.e.msg)) {
      calcdata = 'bh3'
    } else if (/幻塔PSN|幻塔psn|HTPSN|htpsn/.test(this.e.msg)) {
      calcdata = 'htpsn'
    } else if (/幻塔|HT|ht/.test(this.e.msg)) {
      calcdata = 'ht'
    } else if (/战双|ZS|zs|战双帕弥什|帕弥什|PNS|pns/.test(this.e.msg)) {
      calcdata = 'pns'
