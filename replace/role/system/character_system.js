...
export const characters = {
  ...
  20000001: ['风元素', '风主', '风元素主角', '风元素旅行者', '龙卷风'],
  20000002: ['岩元素', '岩主', '岩元素主角', '岩元素旅行者', '荒星'],
  20000003: ['雷元素', '雷主', '雷元素主角', '雷元素旅行者', '充电宝'],
  20000004: ['草元素', '草主', '草元素主角', '草元素旅行者', '蘑菇发射器'],
  20000005: ['水元素', '水主', '水元素主角', '水元素旅行者'],
  20000006: ['火元素', '火主', '火元素主角', '火元素旅行者'],
  20000007: ['冰元素', '冰主', '冰元素主角', '冰元素旅行者'],
  20000008: ['无元素', '原人', '无派蒙'],
  20000009: ['派蒙', '应急食物', '应急食品', '吉祥物', '宠物', '外置器官', '会说话的动物', '矮堇瓜', '飞行矮堇瓜', '最好的伙伴'],
