export const characterBuffGs = {
  ...
  data: {
    ...
    _atkBase: ({ attr, characterName }) => ['玛薇卡'].includes(characterName) ? (attr.atk.base + 200) : attr.atk.base,
    _atkPct: ({ calc, attr, characterName }) => calc(attr.atk) - (['玛薇卡'].includes(characterName) ? (attr.atk.base + 200) : attr.atk.base),
